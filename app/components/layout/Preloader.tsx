...
const IMAGES = [
  ...
  '/preloader/roselia-2.jpeg',
  '/preloader/roselia-3.jpeg',
  '/preloader/roselia-4.jpeg',
  '/preloader/roselia-5.jpeg',
  '/preloader/roselia-6.jpeg',
]
      ...
      >
        <div className="flex flex-col items-center gap-2">
          ...
          <motion.span
            ...
            className="font-[var(--font-syne)] font-light text-white/60 uppercase tracking-widest whitespace-nowrap"
            style={{ fontSize: 'clamp(0.75rem, 2vw, 1.25rem)', letterSpacing: '0.3em' }}
          >
            Vrtni Centar
          </motion.span>
        </div>
